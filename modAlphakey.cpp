/// @file modAlphakey.cpp
/// @brief Реализация методов класса modAlphakey.
...
/// @brief Шифрует текст методом табличной маршрутной перестановки.
/// @param open_text Исходный текст.
/// @return Зашифрованный текст.
string modAlphakey::encrypt(const string& open_text) {
    if (open_text.empty()) {
...
/// @brief Расшифровывает текст методом табличной маршрутной перестановки.
/// @param cipher_text Зашифрованный текст.
/// @return Расшифрованный текст.
string modAlphakey::decrypt(const string& cipher_text) {
